...
class DbTablesSettings extends Model
{
    ...
    public
    function getTableContent($table_main_id, $block_id, $settings)
    {
        $modelColumns=new DbColumnsSettings();
    ...
    public
    function getArrayJoinTables($tables_join, $table_main_name, &$query, &$content_query_settings, &$content_query_tables_settings)
    {
        // dd($tables_join);
        $tables_list = array();
    ...
    public
    function getDataTableContent($table, $data_settings, $settings)
    {
    ...
    public
    function getTablesSettingsByTablesId($tables_id)
    {
        if (!is_array($tables_id)) {
            $tables_id = array($tables_id);
        }
    ...
    public
    function getTablesIdByBlocksId($blocks_id)
    {
        $tables_id = [];
    ...
    public
    function getTableIdByNameAndPurpose($table_name, $table_purpose)
    {
